...
class MyApplication: Application() {
    ...
    companion object{
        ...
        fun loadPdfSize(pdfUrl: String, pdfTitle: String, sizeTv: TextView){
            ...
            val ref = FirebaseStorage.getInstance("gs://kaguribook.appspot.com").getReferenceFromUrl(pdfUrl)
            ref.metadata
        ...
        fun deleteBook(context: Context, bookId: String, bookUrl: String, bookTitle: String){
            ...
            val storageReference = FirebaseStorage.getInstance("gs://kaguribook.appspot.com").getReferenceFromUrl(bookUrl)
